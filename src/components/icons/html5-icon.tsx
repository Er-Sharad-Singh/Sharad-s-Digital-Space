...
export function Html5Icon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="m2 12 5 2-5 2" strokeWidth="2" stroke="hsl(var(--primary-foreground))" />
      <path d="m22 12-5 2 5 2" strokeWidth="2" stroke="hsl(var(--primary-foreground))" />
      <path d="M12 2v20" strokeWidth="2" stroke="hsl(var(--primary-foreground))" />
    </svg>
  );
}
